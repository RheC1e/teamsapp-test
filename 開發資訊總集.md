...
### 部署域名
- **測試域名**：teams-sso-test-rho.vercel.app
- **應用程式 ID URI 前綴**：api://teams-sso-test-rho.vercel.app
...
### 應用程式識別碼 URI
- **Application ID URI**：`api://teams-sso-test-rho.vercel.app/33abd69a-d012-498a-bddb-8608cbf10c2d`
...
#### 定義的範圍 (Scopes)
- **範圍名稱**：`access_as_user`
- **完整範圍**：`api://teams-sso-test-rho.vercel.app/33abd69a-d012-498a-bddb-8608cbf10c2d/access_as_user`
- **有權同意者**：管理員和使用者
- **狀態**：已啟用
...
- **URI**：`https://teams-sso-test-rho.vercel.app`
- **數量**：已配置
